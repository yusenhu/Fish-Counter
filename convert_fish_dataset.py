...
- segmentation masks -> convert_kaggle_fish.py
- CSV bounding boxes -> convert_dataset.py
- COCO-style JSON -> convert_dataset.py
- cropped images -> convert_dataset.py
...
from convert_kaggle_fish import convert_kaggle_fish_dataset, create_dataset_yaml
